...
import { idlFactory } from './htv9_backend.did.js';
export { idlFactory } from './htv9_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HTV9_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./htv9_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the htv9_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./htv9_backend.did.js")._SERVICE>}
 */
export const htv9_backend = createActor(canisterId);
