...
import { idlFactory } from './htv9_frontend.did.js';
export { idlFactory } from './htv9_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HTV9_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./htv9_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the htv9_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./htv9_frontend.did.js")._SERVICE>}
 */
export const htv9_frontend = createActor(canisterId);
